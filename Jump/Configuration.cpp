	...
	try
	{
		auto ini = new ini::IniFile(
		{
			new ini::IniSection(GENERAL_SECTION,
			{
				...
				new ini::IniVariable(GENERAL_UP_VAR_NAME, std::to_string(static_cast<sf::Uint32>(up))),
				new ini::IniVariable(GENERAL_DOWN_VAR_NAME, std::to_string(static_cast<sf::Uint32>(down))),
				new ini::IniVariable(GENERAL_LEFT_VAR_NAME, std::to_string(static_cast<sf::Uint32>(left))),
				new ini::IniVariable(GENERAL_RIGHT_VAR_NAME, std::to_string(static_cast<sf::Uint32>(right))),
