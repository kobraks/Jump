...
#define MSG_SECITON_NOT_EXIST_EXCEPTION "Unable to find specific section"
#define MSG_UNABLE_TO_WRITE_EXCEPTION "Unable to open file in write mode"
#define MSG_NOT_INITIALIZED_EXCEPTION "Unable to read memory"
